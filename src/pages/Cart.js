...
export function Cart () {
    ...
    async function addFavorites (id) {
        ...
        UserVerification()
        let markfav = await axios.post('https://react-eden-backend.vercel.app/shop/markFavorite', {id : id}, {
            headers : {
    ...
    async function removeFavorites (id) {
        UserVerification()
        let unmarkFav = await axios.post('https://react-eden-backend.vercel.app/shop/unmarkFavorite', {id : id}, {
            headers : {
                'authorization' : `Bearer ${token}`,
                'Content-Type' : 'application/json'
            }
