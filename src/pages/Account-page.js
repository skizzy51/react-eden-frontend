...
export function AccountPage () {
    ...
    async function changeUsername () {
        ...
        let response = await axios.post('https://eden-react-backend.herokuapp.com/shop/update/username', {username : newUsername}, {
            headers : {
    ...
    async function changePassword () {
        ...
        let response = await axios.post('https://eden-react-backend.herokuapp.com/shop/update/password', passwords, {
            headers : {
                'authorization' : `Bearer ${token}`,
                'Content-Type' : 'application/json'
            }
    ...
    async function deleteUser () {
        let response = await fetch('https://eden-react-backend.herokuapp.com/shop/user', {
            method : 'delete',
            headers : {
                'authorization' : `Bearer ${token}`
            }
