...
export function Cart () {
    ...
    async function addFavorites (id) {
        ...
        UserVerification()
        let markfav = await axios.post('https://eden-react-backend.herokuapp.com/shop/markFavorite', {id : id}, {
            headers : {
    ...
    async function removeFavorites (id) {
        UserVerification()
        let unmarkFav = await axios.post('https://eden-react-backend.herokuapp.com/shop/unmarkFavorite', {id : id}, {
            headers : {
                'authorization' : `Bearer ${token}`,
                'Content-Type' : 'application/json'
            }
