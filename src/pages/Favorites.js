...
export function Favorites () {
    ...
    async function removeFromFavorites (id) {
        UserVerification()
        let response = await axios.post('https://eden-react-backend.herokuapp.com/shop/unmarkFavorite', {id : id}, {
            headers : {
    ...
    useEffect(()=>{
        axios.get('https://eden-react-backend.herokuapp.com/shop/allFavorites', {
