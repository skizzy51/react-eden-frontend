...
export function Home () {
    ...
    useEffect(()=> {
        axios.get('https://eden-backend.cyclic.app/shop/normal-product-tab')
        .then(res => setNormalProductTab(res.data.data)).catch(err => {return})

        axios.get('https://eden-backend.cyclic.app/shop/split-product-tab')
        .then(res => setSplitProductTab(res.data.data)).catch(err => {return})

        axios.get('https://eden-backend.cyclic.app/shop/normal-category-tab')
        .then(res => setNormalCategoryTab(res.data.data)).catch(err => {return})
        
        axios.get('https://eden-backend.cyclic.app/shop/split-category-tab')
